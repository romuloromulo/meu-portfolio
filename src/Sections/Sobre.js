        ...
        <div className="w-4/5 flex flex-col justify-center items-center mt-10 group">
          <div className="border p-2 sm:p-8 md:p-10  lg:p-14  rounded-lg border-cool-black-300  ">
            <p className="text-dim-gray md:text-base text-sm ">
              ...
              React, React Native,TypeScript, MySQL, Supabase, Firebase, Google
              Cloud e Tailwind CSS. Busco sempre estudar constantemente e buscar
              maneiras de aprimorar minhas habilidades. No momento estou me
              aprofundando em <b>Node.js</b>. Minha maior motivação é continuar
              evoluindo até me tornar um desenvolvedor pleno. Além de
              programador, também sou produtor musical e DJ, o que me torna
              ainda mais versátil ao achar soluções e dar pontos de vista.
            </p>
          </div>
        </div>
      </div>
