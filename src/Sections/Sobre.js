        ...
        <div className="w-4/5 flex flex-col justify-center items-center mt-10 group">
          <div className="border p-2 sm:p-8 md:p-10  lg:p-14  rounded-lg border-cool-black-300  ">
            <p className="text-dim-gray md:text-base text-sm ">
              Olá! Meu nome é <b>Rômulo</b>, sou um apaixonado desenvolvedor
              ...
              React e React Native. Busco sempre estudar constantemente e buscar
              maneiras de aprimorar minhas habilidades. Sou movido pela minha
              curiosidade que me impulsiona a criar soluções elegantes e
              funcionais para os desafios que encontro. Minha maior motivação é
              continuar evoluindo até me tornar um desenvolvedor pleno. Estou
              entusiasmado com as oportunidades que o futuro reserva e ansioso
              para enfrentar novos desafios enquanto continuo minha jornada no
